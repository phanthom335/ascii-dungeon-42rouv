    """
    Ascii Dungeon 42rouv
    ====================
    Classic explore game reimagined as a single-file Python script.
...
return {"score": score, "rounds": guessed_in, "won": score > 0}
    ...
    def build_parser() -> argparse.ArgumentParser:
        p = argparse.ArgumentParser(prog=APP_NAME, description="Classic explore game reimagined as a single-file Python script.")
